...
export default function Tutorials() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-12 pt-24">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center mb-4">Tutorials</h1>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-12">Learn how to create amazing artwork with MagicMoments</p>
            ...
            <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <span className="px-3 py-1 bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-300 rounded-full text-sm">{tutorial.level}</span>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">Check out our blog for the latest tips and tricks</p>
          <Link href="/blog" className="inline-flex items-center px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">
            Visit Blog
          </Link>
        </div>
      </div>
